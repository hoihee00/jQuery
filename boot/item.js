...
$(document).ready(function () {
    ...
    if (jspage == 'jsp') {
        // jsp page (상세화면)에서 큰 image slide 숨기기
        ...
        // html page
        let grepData = $.grep(data, function (a, b) { // 카테고리 지정을 위해 grep을 사용해서 필터링
...
function createContentItem(item) {
    ...
    let star = '';
    let cnt = Math.floor(item.star); // 소수점 아래는 무시
    for (let i = 0; i < cnt; i++) {
        star += '&#9733;';
    }
